    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y,
                ...
                RageUI.Settings.Items.Title.Background.Height, 10, 15, 20, 255)
        ...
        if CurrentMenu() and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.ItemOffset,
                    ...
                    RageUI.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 10, 15, 20, 255)
                ...
                if CurrentMenu.Display.PageCounter then
                    if CurrentMenu.PageCounter == nil then
                        RenderText(CurrentMenu.PageCounterColour .. CurrentMenu.Index .. "/" .. CurrentMenu.Options,
                            ...
                            CurrentMenu.Y + RageUI.Settings.Items.Subtitle.PreText.Y + RageUI.ItemOffset + 2, 8, 0.25,
                            245, 245, 245, 255, 2)
                    else
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            RenderRectangle(CurrentMenu.X,
                CurrentMenu.Y + RageUI.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight - 7,
                RageUI.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUI.ItemOffset + 10, 0, 0, 0, 200)
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            ...
            RenderRectangle(CurrentMenu.X,
                ...
                Description.Background.Width + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight + 5, 10, 15, 20,
                255)

            RenderRectangle(CurrentMenu.X,
                CurrentMenu.Y + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset,
                Description.Background.Width + CurrentMenu.WidthOffset, 3, 0, 126, 255, 255)

            RenderText(CurrentMenu.Description, CurrentMenu.X + Description.Text.X,
                CurrentMenu.Y + Description.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 6, 0,
    ...
    if Description ~= "" or Description ~= nil then
        ...
        if Selected and CurrentMenu.Description ~= Description then
            ...
            if DescriptionLineCount > 1 then
                ...
                DescriptionLineCount * 18                                                                         -- maybe bug
            else
